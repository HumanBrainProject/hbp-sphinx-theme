...
project = u'Collaboratory Sphinx Theme'
...
version = re.search(
    r'[0-9]+\.[0-9]+',
    collaboratory_sphinx_theme.__version__
).group()
# The full version, including alpha/beta/rc tags.
release = collaboratory_sphinx_theme.__version__
...
htmlhelp_basename = 'CollaboratorySphinxTheme'
